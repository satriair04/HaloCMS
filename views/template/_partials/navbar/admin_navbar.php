    ...
    <nav class="navbar navbar-expand navbar-dark bg-dark sticky-top">
	  ...
	  <div class="navbar-collapse collapse w-100 order-2 order-md-0 dual-collapse2">
			<ul class="navbar-nav mx-auto">
				<li class="nav-item <?php if($this->uri->segment(3)=="create"){echo 'active';}?>" data-toggle="tooltip" title="Tambah pengguna baru">
          <a class="nav-link" href="<?php echo site_url('access/admin/create')?>">
            <i class="fas fa-user-plus fa-fw"></i>
          </a>
        </li>
        <li class="nav-item <?php if($this->uri->segment(2)=="admin" && $this->uri->segment(3)=="index" || $this->uri->segment(3)=="read" || $this->uri->segment(3)=="update" || $this->uri->segment(3)=="files"){echo 'active';}?>" data-toggle="tooltip" title="Home / beranda">
