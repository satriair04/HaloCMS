      ...
      <!-- Menu mid -->
		<div class="navbar-collapse collapse w-100 order-2 order-md-0 dual-collapse2">
			<ul class="navbar-nav mx-auto">
				<li class="nav-item <?php if($this->uri->segment(2)=="redaktur" && $this->uri->segment(3)=="index" || $this->uri->segment(3)=="read" || $this->uri->segment(3)=="update" || $this->uri->segment(3)=="files"){echo 'active';}?>" data-toggle="tooltip" title="Home / beranda">
